...
# Check if signal is currently active or waiting for next candle block
is_active = time_into_block <= (tf_seconds - 5)
...
# TRIGGER NOTIFICATIONS & SOUND ONLY WHEN ACTIVE
if is_active:
    components.html(f"""
    <script>
